local main = UIMenu.CreateMenu(fConfig.name, 'Main');

local _self = UIMenu.CreateSubMenu(main, fConfig.name, 'Self');
local pedm = UIMenu.CreateSubMenu(_self, fConfig.name, 'Ped');
local pedgamelist = UIMenu.CreateSubMenu(pedm, fConfig.name, 'Ped List');
local anims = UIMenu.CreateSubMenu(_self, fConfig.name, 'Animations');

local vehicle = UIMenu.CreateSubMenu(main, fConfig.name, 'Vehicle');
local weapon = UIMenu.CreateSubMenu(main, fConfig.name, 'Weapon');
local settings = UIMenu.CreateSubMenu(main, fConfig.name, 'Settings');
...
main:IsVisible(function(Items)
    Items:Button('Self', nil, {}, true, {}, _self);
...
_self:IsVisible(function(Items)
